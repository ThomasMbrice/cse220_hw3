...
int main(void) {
  ...
  int num_tiles_placed = 0;
   ...
   game = place_tiles(game, 2, 3, 'V', "T PMAN", &num_tiles_placed);
    ...
    game = place_tiles(game, 2, 6, 'H', "EEKHEARTEDNESS", &num_tiles_placed); //meekheartedness
    game = place_tiles(game, 2, 6, 'V', "MEEKHEARTEDNESS", &num_tiles_placed); //meekheartedness
